...
SQUARE_BOTOX_SERVICE_VARIATION_ID=
SQUARE_BOTOX_SERVICE_VARIATION_VERSION=
...
Square paid appointment workflow requirements:
...
- `SQUARE_BOTOX_SERVICE_VARIATION_ID`
- `SQUARE_BOTOX_SERVICE_VARIATION_VERSION`
- `SQUARE_BOTOX_DURATION_MINUTES`
- `SQUARE_BOTOX_DEPOSIT_AMOUNT_CENTS`
- `SQUARE_CURRENCY`
- `SQUARE_WEBHOOK_SIGNATURE_KEY` for Square webhook verification
- `SQUARE_WEBHOOK_NOTIFICATION_URL` for Square webhook verification

Optional:

- `TELNYX_PUBLIC_KEY` for signature verification
- `TELNYX_MESSAGING_FROM_NUMBER` for manual follow-up SMS
- `TELNYX_WHATSAPP_FROM_NUMBER` and approved WhatsApp template names for paid appointment messages
